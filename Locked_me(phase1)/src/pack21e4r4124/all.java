...
public class all {
	...
	static int choice = 0;
	// Creating a single scanner class to be accessed in all the functions static Scanner readScanner = new Scanner(System.in);
	static Scanner readScanner = new Scanner(System.in);
	static final String errorMessage = "Some error has occured, Please contact: admin@Vasavi.com";
	/**
	...
	*/
	...
	public static void displayMenu() { 
		...
		System.out.println("\t\tDeveloper Details: Vasavi.N");
		System.out.println("*******************************************");
	}
	/**
	...
	*/
	...
	//	using try-catch block try {
		File folder = new File("C:\\Users\\Ayush\\Desktop"); 
	...
	*/
	...
	// Using Try-Catch Block try {
		try {
			...
			FileWriter myWriter = new FileWriter("C:\\Users\\Ayush\\Desktop" + "//" + fileName); 
			...
			System.out.println("File Successfully Created."); myWriter.close();
		} 
		catch (Exception Ex) {
			System.out.println(errorMessage);
		}
	...
	*/
	...
	//		Creating a Try Catch block try {
		try {
			String fileName;
			System.out.println("Enter the file name to be deleted: "); 
			fileName = readScanner.nextLine();
			File file = new File("C:\\Users\\Ayush\\Desktop" + "//" + fileName); 
			if (file.exists()) {
			file.delete();
	...
	*/
	public static void main(String[] args) {
		// Using Do-while loop so that this application runs repeatedly do {
		displayMenu();
		System.out.println("Enter your choice: ");
		choice = readScanner.nextInt();
		//	Using Switch Case
		switch (choice) { 
			case 1: getAllFiles(); 
			break;
		...
		while (choice > 0) {
		// Closing the scanner in order to stop the leak of memory, when input is taken readScanner.close();
			 readScanner.close();
		}
	}
}
